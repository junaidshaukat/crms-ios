...
class OrganizationContactUpdateReq {
  String? contactName;
  String? contactEmail;
  String? contactPhone;

  OrganizationContactUpdateReq({
    this.contactName,
    this.contactEmail,
    this.contactPhone,
  });
...
class OrganizationContactUpdateRes {
  String? instanceId;
  bool? result;
  String? message;
  MessageDetails? messageDetails;
  OrganizationContactUpdateData? data;

  OrganizationContactUpdateRes({
    this.instanceId,
    this.result,
    this.message,
    this.messageDetails,
  ...
  factory OrganizationContactUpdateRes.fromJson(Map<String, dynamic> json) {
    return OrganizationContactUpdateRes(
      instanceId: json['instanceId'] ?? '',
      result: json['result'] ?? false,
      message: json['message'] ?? '',
      messageDetails: MessageDetails.fromJson(json['messageDetails']),
      data: OrganizationContactUpdateData.fromJson(json['data'] ?? {}),
    );
  }
}

class OrganizationContactUpdateData {
  int? tagNumber;
  String? name;
  String? logo;
  ...
  factory OrganizationContactUpdateData.fromJson(Map<String, dynamic> json) {
    return OrganizationContactUpdateData(
