    ...
    return Container(
      ...
      child: TextField(
        ...
        style: const TextStyle(
          ...
          color: Color(0XFF007C16), //0xFF0175C2
          fontSize: 15,
          height: 1.5,
...
class _PageControlButtonState extends State<_PageControlButton> {
  Color normalTextColor = const Color(0XFF007C16); //0xFF0175C2
...
class __PageItemState extends State<_PageItem> {
  ...
  Color normalHighlightColor = const Color(0XFF007C16); //0xFF0175C2
...
class _DoubleTextInputFormatter extends _BaseTextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (newText.indexOf(".") != newText.lastIndexOf(".")) {
      newText = oldText;
      return TextEditingValue(text: oldText, selection: oldValue.selection);
    }
    if (newText.endsWith(".")) {
    ...
    return TextEditingValue(text: handleText, selection: textSelection);
  }
}
...
class _IntTextInputFormatter extends _BaseTextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    return TextEditingValue(text: finalText, selection: selection);
  }
}
